...
/**
 * @author ：xzyuan
 * @date ：Created in 2019/12/6 14:24
 * @description：
 * @version: 1.0
 */
@Slf4j
public class HcGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public HcGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
