...
/**
 * @author ：xzyuan
 * @date ：Created in 2019/6/23 9:07
 * @description：更好的sql拦截器
 * @version: 1.0
 */
@Setter
@Accessors(chain = true)
@Intercepts({@Signature(type = StatementHandler.class, method = "prepare", args = {Connection.class, Integer.class})})
public class BetterPaginationInterceptor extends AbstractSqlParserHandler implements Interceptor {
    /**
     * COUNT SQL 解析
     */
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        //todo 此处可提供修改sql，例如添加全局的查询条件 buildSql = buildSql+" where del_flag=1 ";
